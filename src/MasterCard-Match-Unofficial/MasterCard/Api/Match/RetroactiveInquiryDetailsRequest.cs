...
namespace MasterCard.Api.Match {
    public class RetroactiveInquiryDetailsRequest : BaseObject {
        ...
        public static RetroactiveInquiryDetailsRequest Create(RequestMap map, IndividualApiConfig apiConfig = null) {
            return BaseObject.Execute("create", new RetroactiveInquiryDetailsRequest(map), apiConfig);
        }
        ...
        /// <param name="map">containing the required parameters to create a new object</param>
        /// <returns>RetroactiveInquiryDetailsRequest of the response of created instance.</returns>
        public static RetroactiveInquiryDetailsRequest Create(IDictionary<string, object> map, IndividualApiConfig apiConfig = null) {
            return BaseObject.Execute("create", new RetroactiveInquiryDetailsRequest(map), apiConfig);
        }
